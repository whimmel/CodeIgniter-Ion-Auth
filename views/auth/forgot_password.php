			    ...
			    <td width=450 align="center" valign="middle"> 
				 <input type="hidden" name="psRefer" value="">
			       ...
			       <tr>
			        ...
			        <td align="left" width=60%><?php echo form_input($email);?>
			        </td>
			       </tr>
			       ...
			       <tr>
			           <td colspan=2 align="center">Please enter your username so we can send you an email to reset your password.
			           </td>
			       </tr>
