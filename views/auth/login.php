			    ...
			    <td width=450 align="center" valign="middle"> 
				 <input type="hidden" name="psRefer" value="">
			       ...
			       <tr>
			        ...
			        <td align="left" width=60%><?php echo form_input($identity);?>
			        </td>
			       </tr>
			       <tr>
			            <td align="right" width=40%>Password:</td>
			        <td align="left" width=60%><?php echo form_input($password);?></td>
			
			       </tr>
			       
			       <tr>
			           <td align="right" width=40%>Remember Me:</td>
			           <td align="left"  width=60%><?php echo form_checkbox('remember', '1', FALSE, 'id="remember"');?></td>
			       </tr>
			       
			       <tr>
			        <td align="right" width=40%><?php echo form_submit('submit', 'Login');?></td>
			        <td align="left" width=60%><?php echo form_reset('reset', 'Clear');?></td>
			       </tr>
			       
			       <tr>
			           <td colspan=2 align="center"><a href="forgot_password">Forgot your password?</a></td>
			       </tr>
